...
public final class Scoreboard implements net.minestom.server.scoreboard.Scoreboard {
    ...
    public @NotNull ScoreboardObjectivePacket getCreationObjectivePacket(Component value, ScoreboardObjectivePacket.Type type) {
        return new ScoreboardObjectivePacket(getObjectiveName(), (byte) 0, value, type, net.minestom.server.scoreboard.Sidebar.NumberFormat.blank());
    }
    ...
    public void setTitle(@NotNull Component title) {
        ...
        sendPacketToViewers(new ScoreboardObjectivePacket(objectiveName, (byte) 2, title,
                ScoreboardObjectivePacket.Type.INTEGER, net.minestom.server.scoreboard.Sidebar.NumberFormat.blank()));
    }
